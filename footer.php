    ...
    <footer class="footer bg-dark pb-4 py-lg-5" data-bs-theme="dark">
      <div class="pt-5 pt-lg-4 mt-sm-2 mt-md-3 container">
        <div class="pb-5 row">
    ...
    <div class="floating-buttons position-fixed top-50 end-0 z-sticky me-3 me-xl-4 pb-4">
      <a class="btn-scroll-top btn btn-sm bg-body border-0 rounded-pill shadow animate-slide-end" href="furniture.html#top">Top <i class="ci-arrow-right fs-base ms-1 me-n1 animate-target"></i>
  ...
  <!-- Bootstrap 5 JS (solo para single-product.php) -->
